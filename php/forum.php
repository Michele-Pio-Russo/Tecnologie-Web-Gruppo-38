...
<body>
    ...
    <div class="main-content">
        <div class="content">
            ...
            <table class="tabella">
                <tr><th>Categoria</th><th>Rivoluzione Chiave</th><th>Impatto Nel Mondo</th></tr>
                <tr><th>Animazione</th><td>L'era della CGI (Toy Story, 1995)</td><td>Ha segnato il passaggio dal disegno a mano alla modellazione 3D digitale, cambiando per sempre il cinema d'animazione.</td></tr>
                <tr><th>Videogiochi</th><td>Il 3D e lo Z-Targeting (Ocarina of Time, 1998)</td><td>Ha definito lo standard per l'esplorazione e il combattimento negli spazi tridimensionali, influenzando ogni open-world moderno.</td></tr>
                <tr><th>Cinema</th><td>L'avvento del Sonoro (1927)</td><td>Ha trasformato il cinema da un'arte puramente visiva e mimica in un'esperienza multisensoriale completa.</td></tr>
                <tr><th>Hip-Hop</th><td>Il "Breakbeat" (DJ Kool Herc, 1973)</td><td>Isolando le parti ritmiche dei dischi per far ballare i "B-Boys", ha dato vita a una cultura globale che unisce musica, danza e arte.</td></tr>
                <tr><th>Carte</th><td>Il formato TCG (Magic: The Gathering, 1993)</td><td>Ha inventato il concetto di "gioco di carte collezionabili", trasformando semplici mazzi di carte in asset di valore e mondi narrativi complessi.</td></tr>
                <tr><th>Fotografia</th><td>La Digitalizzazione (Sensore CCD)</td><td>Ha reso la fotografia istantanea e accessibile a chiunque, eliminando la necessità dello sviluppo chimico e portando alla nascita dei social media visivi.</td></tr>
                <tr><th>Cucina</th><td>La Brigata di Cucina (Auguste Escoffier)</td><td>Ha introdotto una gerarchia militare e una divisione dei compiti scientifica, permettendo alla ristorazione di diventare veloce, efficiente e professionale.</td></tr>
            </table>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                <img src="../imgs/Form/Ringraziamenti.jpg" alt="Ringraziamenti" width="300" align="right" class="image1">
